...
> [!note]
> この記事は[木Advent Calendar 2025](https://adventar.org/calendars/12007)の20日目の記事です。
...
testing-libraryでアサーションテストをする場合は、例えばReact Ariaでは[去年の記事](https://zenn.dev/mehm8128/articles/adv2024-react-aria-test)で書いたように、「このロールがついている」「tabIndexが0である」「aria-disabledがついている」というようなテストを1つ1つ書いていく必要があります。また、「aria-labelledbyにちゃんとこのIDが指定されている」のようなテストもありました。
