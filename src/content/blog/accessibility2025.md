...
真面目な話は苦手なのですが年末ということで、最近考えている「アクセシビリティに取り組む意味」について書きます。
...
最後に、直接は関係ないけど参考文献として、この前のJSConfでの基調講演の後に投稿された[Jxckさん](https://x.com/Jxck_)の記事も引用しておきます。
...
Jxckさんの記事にあるようにWebの定義が明確でないとしても、様々なWebの仕様を策定しているW3Cが提言している以上、Webが「普遍的で、誰でもアクセスできるものであるべき」という一面は持っているし、それに向かって仕様策定が行われていると考えられます。

Webは本来、現実世界と比べてアクセシブルなものです。自分の考えや持っている情報をWebにアップロードするだけで、全世界に公開することができます。このブログ記事も、Webがなければ原稿用紙に書き、それをわざわざ伝えたい人の人数分コピーして伝えたい人一人ひとりに郵送したり手渡ししたりしなければならなかったかもしれません。しかし、Webのおかげで`git push`するだけで全世界に公開することができています。また、Webに限らずITツールは全てそうですが、紙だとOCRなどで文字を読み取らなければ音声に変換できず、直接目から情報を得られない状況で情報を得ることが難しいです。一方、Webの場合は文字が電子情報としてデータになっているので、そのまま音声として読み上げさせることができます。

思い返してみると、世界中のコンテンツにアクセスできたり、遠く離れた知らない人とコミュニケーションを取れるというのが魅力の一つだと思ってインターネットを利用してきました。やや現代的だと思われるかも知れませんがXやYoutube、オンラインゲームなどはその代表例です。
そう考えたときに、自分はそのように普遍的なWebを「全人類」がアクセスできるようにしていきたいです。そして、Webに限らず世の中全てがアクセシブルになって、同じように努力して同じものを求める人が同じものを得られるような社会になってほしいと思っています。少し規模が大きいかも知れないし、自分がそんなに大きなことをできるとも思っていないですが、自分のできる範囲でアクセシビリティの活動を行っていくための方向づけとしては十分だと思います。
...
- [Web技術の歴史](https://www.biprogy.com/pdf/11001.pdf)
